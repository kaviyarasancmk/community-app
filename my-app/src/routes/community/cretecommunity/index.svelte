...
// Now, the 'categories' array is sorted in alphabetical order
...
function selectCategory(category) {
  ...
  function handleCreateCommunity(event) {
    ...
    if (communityDescription.length < 100 || communityDescription.length > 1000) {
    ...
    // All checks passed, you can proceed to store the data
  }
</script>
    ...
    <div class="mb-4 w-full">
      ...
      <div class="ml-10 grid lg:grid-cols-3 grid-cols-2">
        <div class="mb-4 w-full">
          ...
          <input type="checkbox" id="adminPostAccess" name="adminPostAccess" class="mr-2" />
        ...
        <div class="mb-4 w-full">
          ...
          <input type="checkbox" id="adminEditAccess" name="adminEditAccess" class="mr-2" />
        ...
        <div class="mb-4 w-full">
          ...
          <input type="checkbox" id="adminDeleteAccess" name="adminDeleteAccess" class="mr-2" />
          <span class="text-sm text-gray-600">Grant Delete Messages Access</span>
        </div>

        <div class="mb-4 w-full">
          <label for="adminPollsAccess" class="block text-sm font-medium text-gray-600">Polls Access</label>
          <input type="checkbox" id="adminPollsAccess" name="adminPollsAccess" class="mr-2" />
        ...
        <div class="mb-4 w-full">
          ...
          <input type="checkbox" id="adminInviteAccess" name="adminInviteAccess" class="mr-2" />
        ...
        <div class="mb-4 w-full">
          ...
          <input type="checkbox" id="adminChatManagerAccess" name="adminChatManagerAccess" class="mr-2" />
        ...
        <div class="mb-4 w-full">
          ...
          <input type="checkbox" id="adminChatMemberAccess" name="adminChatMemberAccess" class="mr-2" />
